...
struct MessageInputField: View {
    ...
    var body: some View {
        HStack(alignment: .center) {
            CustomTextField(placeholder: Text("Enter a message..."), inputText: $inputText)
            
            Button {
                chatViewModel.sendMessage(group_id: "5000", sender: "Anthony Stem", text: inputText, received: false, pinned: false)
                inputText = ""
            } label: {
