...
import FirebaseAuth
/*
    View displays all groceries in the database, organized by food category
 
    Also displays groceries crossed off after you purchased them (swipe left).
    You can swipe right on purchased grocery to add it back to the list, or click the trashcan
